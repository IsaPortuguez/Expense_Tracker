...
class _ExpensesState extends State<Expenses> {
  ...
  void _openAddExpenseOverlay() {
    showModalBottomSheet(
      ...
      useSafeArea: true, //Ensures that device characteristics are avoided
          ...
          onPressed: () {
            setState(() {
              _registerExpenses.insert(
                expenseIndex,
                expense,
              ); //We used insert because we need to insert the expense ion the same position.
            });
          },
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Ternary expression to ensure the UI remains responsive in landscape orientation.
      body: width < 600
          ? Column(
              children: [
